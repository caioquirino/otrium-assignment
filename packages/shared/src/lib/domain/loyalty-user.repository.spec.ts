...
describe('DynamoDBLoyaltyUserRepository', () => {
  ...
  describe('updatePoints', () => {
    it('should update points for an existing user', async () => {
      ...
      const updatedUser = await repository.updatePoints(
        userId,
        pointsToAdd,
        transactionId,
        orderId,
    ...
    it('should throw an error if transactionId already exists', async () => {
      ...
      await expect(repository.updatePoints(userId, pointsToAdd, transactionId, orderId)).rejects.toThrow(
